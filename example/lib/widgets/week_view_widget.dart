...
class WeekViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Allow event tiles to grow larger on wider screens. Pick a reasonable
    // minimum so they don't become too small on narrow layouts.
    final maxEventWidth = max(120.0, effectiveWidth / 4);
